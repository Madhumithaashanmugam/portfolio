    ...
    <section id="experience" className="mt-16">
      ...
      >
        ...
        <div className="mt-10 relative lg:pl-12">
          <div className="hidden lg:block absolute left-6 top-8 bottom-8 w-1 bg-gradient-to-b from-[#a78bfa] to-transparent opacity-60 rounded" />
          <div className="space-y-8">
            {experiences.map((item, index) => (
              <motion.div
                ...
                className="relative lg:ml-8 rounded-[28px] border border-white/8 bg-slate-950/80 p-6 shadow-soft"
              >
